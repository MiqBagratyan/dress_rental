<?php
namespace common\components\filekit\src;

use common\components\Helper;
use Yii;
use League\Flysystem\FilesystemInterface;
use common\components\filekit\src\events\StorageEvent;
use common\components\filekit\src\filesystem\FilesystemBuilderInterface;
        ...
        if ($preserveFileName === false) {
            do {
                ...
                if (!$pathPrefix) {
                    ...
                    $path = implode(DIRECTORY_SEPARATOR, [$pathPrefix, $filename]);
                }
