                ...
                if (($tableSchema = $generator->getTableSchema()) === false) {
                    ...
                    foreach ($tableSchema->columns as $column) {
                        ...
                        if ($column->name === 'status') {
                            ...
                            echo "                    \$s = \\common\\models\\" . StringHelper::basename($generator->modelClass) . "::statuses();\n";
                            echo "                    return \$s[\$data->status];\n";
                            echo "                },\n";
                            echo "                'attribute' => 'status',\n";
                            echo "                'filter' => \\common\\models\\" . StringHelper::basename($generator->modelClass) . "::statuses(),\n";
                            echo "            ],\n";
                        } elseif (++$count < 6) {
